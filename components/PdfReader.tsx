...
<body>
  ...
  <script>
    ...
    // ... (createPageElements, renderPage, renderAllPages, setupDrawingEvents, setDrawingMode same)
    ...
    function drawHighlightOnCanvas(ctx, item, viewport) {
       ...
       // item.transform[3] is height, item.transform[0] is generally scale X but item.width is already scaled? 
       // In PDF.js item.width is the width in User Units. item.transform[4] is X in User Units.
       // So we just add the offset in User Units.
